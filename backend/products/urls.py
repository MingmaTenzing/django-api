...
from .views import search_list_view,  ProductListCreateView, products_model_viewset,Product_detail_view, Product_create_api_view, Product_list_view, alt_api_view, Product_update_view, Product_destory_view, product_mixin_view
...
urlpatterns = [
    ...
    path('algolia_search',  search_list_view.as_view()),
